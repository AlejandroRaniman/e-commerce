...
import '../../styles/categorias/Celebraciones.css';
...
const Celebraciones = () => {
  ...
  const fetchProducts = async () => {
    try {
      ...
      // Filtrar productos para la categoría "Celebraciones"
      const categoryProducts = data.filter(
        product => Array.isArray(product.categories) && product.categories.includes('Celebraciones')
      );
